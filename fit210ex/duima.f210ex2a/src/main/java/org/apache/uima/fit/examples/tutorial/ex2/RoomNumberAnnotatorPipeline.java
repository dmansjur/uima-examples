...
public class RoomNumberAnnotatorPipeline {
  ...
  public static void main(String[] args) throws UIMAException {
	  ...
	  AnalysisEngine analysisEngine = createEngine(RoomNumberAnnotator.class, "Patterns", new String[] { "\\b[0-4]\\d-[0-2]\\d\\d\\b", "\\b[G1-4][NS]-[A-Z]\\d\\d\\b" }, "Locations", new String[] { "Downtown", "Uptown" });
