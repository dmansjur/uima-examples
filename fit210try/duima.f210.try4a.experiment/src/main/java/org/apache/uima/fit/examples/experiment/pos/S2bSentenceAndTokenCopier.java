 ...
 */
@SofaCapability(inputSofas = { S0RunExperiment.VIEW1, S0RunExperiment.VIEW2 })
public class S2bSentenceAndTokenCopier extends JCasAnnotator_ImplBase {

  @Override
  public void process(JCas jCas) throws AnalysisEngineProcessException {
    try {
      JCas view1 = jCas.getView( S0RunExperiment.VIEW1);
      JCas view2 = jCas.getView( S0RunExperiment.VIEW2);
